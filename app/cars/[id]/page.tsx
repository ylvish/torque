                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="grid grid-cols-3 md:grid-cols-6 gap-4 p-4 bg-zinc-900/50 border border-white/5 rounded-2xl">
                            {specs.map((spec) => (
                                <div key={spec.label} className="text-center">
                                    <div className="inline-flex items-center justify-center w-10 h-10 mb-2 bg-red-500/10 rounded-lg">
                                        <spec.icon className="h-5 w-5 text-red-500" />
                                    </div>
                        ...
                        {listing.why_we_like_it && (
                            <div className="p-6 bg-gradient-to-r from-red-600/10 to-transparent border border-red-500/20 rounded-2xl">
                            ...
                            <div className="p-6 bg-zinc-900 border border-white/5 rounded-2xl">
                                ...
                                <div className="space-y-3">
                                    <button
                                        ...
                                        className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-red-600 to-red-700 text-black font-semibold rounded-xl hover:shadow-lg hover:shadow-red-500/25 transition-all"
                                    >
                            ...
                            {submitted ? (
                                <div className="text-center py-8">
                                    ...
                                    <button
                                        ...
                                        className="px-6 py-2.5 bg-red-500 text-black font-medium rounded-full"
                                    >
                                        Done
                                    </button>
                                </div>
                                ...
                                <>
                                    ...
                                    <form onSubmit={handleLeadSubmit} className="space-y-4">
                                        ...
                                        <button
                                            ...
                                            className="w-full py-3 bg-gradient-to-r from-red-600 to-red-700 text-black font-semibold rounded-xl hover:shadow-lg hover:shadow-red-500/25 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                                        >
                                            {isSubmitting ? (
                                                <>
